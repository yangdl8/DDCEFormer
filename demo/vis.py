...
def get_pose3D(video_path, output_dir, fix_z):
    ...
    args.k_ratio, args.g_ratio = 0.75, 1.5
    args.previous_dir = './pretrained'

    ## Reload 
    model = Model(args).cuda()

    # Put the pretrained model in './pretrained'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video', type=str, default='sample_video1.mp4', help='input video')
